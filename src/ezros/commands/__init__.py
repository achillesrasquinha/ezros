...
from ezros.commands.util 	import cli_format
...
from ezros 	import cli
from bpyutils._compat		    import builtins, iteritems
from ezros.__attr__      	import __name__
from ezros.exception      import DependencyNotFoundError
...
"ezros". Kindly post an issue at https://github.com/achillesrasquinha/ezros/issues""", cli.RED))
        else:
            raise e
